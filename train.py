...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exp24/weights/best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/hub/yolov5s6.yaml', help='model.yaml path')
